...
export const getStaticProps = ({ params }) => {
  return fetch(`https://api.github.com/repos/easy-node-pro/nextra`)
    .then((res) => res.json())
    .then((repo) => ({
      props: {
...
## Github Repository
This guides repository has <Stars /> 🌟 on [GitHub](https://github.com/easy-node-pro/nextra). If you enjoy our guides would you head to our page and give us a 🌟 today? Thank you!  
